...
#game-screen {
  ...
  flex-direction: column;
  align-items: center;
  padding-top: 220px; /* cukup tinggi biar gak ketiban header */
  min-height: 100vh;
  overflow-y: auto;
  overflow-x: hidden;
}
...
#farm-area {
  ...
  background: #8b4513;
  padding: 100px 30px 30px 30px; /* Geser ke kanan dengan padding-left: 70px */
  border-radius: 10px;
  width: 100%;
  max-width: 410px;
  height: 410px;
...
@media (max-width: 480px) {
  #farm-area {
    ...
    align-content: space-around;
    padding: 80px 20px 20px 80px; /* Sesuaikan padding-left jadi 60px */
    width: 100%;
    max-width: 450px;
    height: 450px;
    margin: 0 auto;
...
@media (max-width: 360px) {
  #farm-area {
    ...
    justify-content: center !important;
    align-content: space-around;
    padding: 70px 15px 15px 70px; /* Sesuaikan padding-left jadi 50px */
    width: 100%;
    max-width: 330px;
    height: 330px;
    margin: 0 auto;
